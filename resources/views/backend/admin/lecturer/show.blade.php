		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					...
					<section class="box-typical">
						<header class="box-typical-header-sm">CRB Information</header>
								...
								<div class="user-card-row">
									<div class="tbl-row">
										<div class="tbl-cell">
											...
											<div class="tbl">
												<div class="tbl-row">
													<div class="tbl-cell">ID Number:</div>
													<div class="tbl-cell tbl-cell-time _green">{!! $crb->identity_number !!}</div>
												</div>
												<div class="tbl-row">
													<div class="tbl-cell">First Name:</div>
													<div class="tbl-cell tbl-cell-time _green">{!! $crb->first_name !!}</div>
												</div>
												<div class="tbl-row">
													<div class="tbl-cell">Last Name:</div>
													<div class="tbl-cell tbl-cell-time _green">{!! $crb->last_name !!}</div>
												</div>
												<div class="tbl-row">
													<div class="tbl-cell">Gender:</div>
													<div class="tbl-cell tbl-cell-time _green">{!! $crb->gender !!}</div>
												</div>
												<div class="tbl-row">
													<div class="tbl-cell">DOB:</div>
													<div class="tbl-cell tbl-cell-time _green">{!! $crb->dob !!}</div>
												</div>
