	...
	<div class="content-container" id="content" style="margin-left: 20%; margin-top: 2%;">
		<div class="page page-ui-tables">
			<ol class="breadcrumb breadcrumb-small">
				<li>Home</li>
				<li class="active"><a href="#/tables/tables">Class</a></li>
			</ol>
							...
							<div class="panel panel-lined table-responsive panel-hovered mb20 data-table" style="padding-bottom: 20px">
								...
								<div class="panel-body">
									...
									<div class="pull-right">
										<a href="{!! route('admin.class.create') !!}">Add a New class</a>
									</div>
								</div>
							<!-- data table -->
								...
								<tbody>
									...
									@if($classes->count())
			                            @foreach($classes as $class)
											<tr>
												<td>{!! $class->name !!}</td>
												<td><a href="{!! route('admin.class.show', $class->id) !!}">Show</a></td>
												<td><a href="{!! route('admin.class.edit', $class->id) !!}">Edit</a></td>
											</tr>
										@endforeach
			                        @endif
								</tbody>
